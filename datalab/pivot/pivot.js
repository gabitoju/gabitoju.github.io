...
(function() {
  var $, PivotData, addSeparators, aggregatorTemplates, aggregators, convertToArray, dayNames, derivers, forEachRecord, getPivotData, mthNames, naturalSort, numberFormat, pivotTableRenderer, renderers, spanSize, zeroPad,
    __slice = [].slice,
  ...
  pivotTableRenderer = function(pivotData, opts) {
    var aggregator, c, colAttrs, colKey, colKeys, defaults, i, j, r, result, rowAttrs, rowKey, rowKeys, td, th, totalAggregator, tr, txt, val, x;
    defaults = {
      localeStrings: {
        totals: "Totales"
      }
  ...
  $.fn.pivotUI = function(input, inputOpts, overwrite) {
    ...
    try {
      ...
      $("<td class='pvtAxisContainer pvtHorizList pvtVals'>").appendTo(tr1).append($("<br>"))/*.append(aggregator)*/;
